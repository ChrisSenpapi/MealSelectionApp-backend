...
MealIngredient.create(meal_id:1, ingredient_id:1, ingredient_id:2, ingredient_id:3)
MealIngredient.create(meal_id:2, ingredient_id:4, ingredient_id:6, ingredient_id:7)
MealIngredient.create(meal_id:3, ingredient_id:8, ingredient_id:10, ingredient_id:7)
MealIngredient.create(meal_id:4, ingredient_id:8, ingredient_id:9, ingredient_id:10)
MealIngredient.create(meal_id:5, ingredient_id:11, ingredient_id:10, ingredient_id:9) 
